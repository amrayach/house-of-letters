...
4. Intro/runtime sequencing risk
   - the current dual-gate transition and double-render-loop boot sequence are easy to break accidentally
...
6. Only after those decisions, do deeper refactors of controls, renderer lifecycle, or data layout.
